...
def calculate_demographic_data(print_data=True):
    ...
    higher_education_rich = round((higher_education_rich / higher_education_total) * 100, 1)
    
    lower_education_rich = len(lower_education[lower_education['salary'] == '>50K'])
    lower_education_total = len(lower_education)
    lower_education_rich = round((lower_education_rich / lower_education_total) * 100, 1)
    ...
    country_percentages = (country_rich_counts / country_counts * 100).round(1)
